...
class Addressdetails extends StatefulWidget {
  ...
  Addressdetails({required this.userId});

  @override
  State<Addressdetails> createState() => _ProfileScreenState();
}

class _ProfileScreenState extends State<Addressdetails> {
  @override
  void initState() {
    super.initState();
              ...
              children: [
                ...
                ElevatedButton(
                  onPressed: () async {
                    ...
                    // Optionally, handle the new address here
                  },
